 ...
 */
export function createElement<T extends keyof HTMLElementTagNameMap>(className: string, tagName: T, appendToEl?: Node) {
 ...
 * @returns {number}
 */
export function getDistanceBetween(p1: Point, p2: Point) {
 ...
 */
export function setTransitionStyle(el: HTMLElement, prop?: string, duration?: number, ease?: string) {
 ...
 */
export function setWidthHeight(el: HTMLElement, w: string | number, h: string | number) {
 ...
 * @param {HTMLElement} el
 */
export function removeTransitionStyle(el: HTMLElement) {
 ...
 */
export function decodeImage(img: HTMLImageElement) {
  if ('decode' in img) {
 ...
 *
 * @param {import('@/photoswipe').ElementProvider} [option]
 ...
 * @returns {boolean}
 */
export function isPswpClass(fn: any) {
