...
class SpringEaser {
   ...
   */
  easeFrame(deltaPosition: number, deltaTime: number) {
    ...
    if (this._dampingRatio === 1) {
      ...
      coeff =
        (1 / this._dampedFrequency) * (this._dampingRatio * this._naturalFrequency * deltaPosition + this.velocity);
      ...
      this.velocity =
        ...
        naturalDumpingPow *
          (-this._dampedFrequency * deltaPosition * dumpedFSin + this._dampedFrequency * coeff * dumpedFCos);
    }
