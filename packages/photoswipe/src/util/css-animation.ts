import { setTransitionStyle, removeTransitionStyle } from '@/util/util';
...
export interface CssAnimationProps extends SharedAnimationProps, DefaultCssAnimationProps {}
...
class CSSAnimation {
  ...
  onFinish: () => void;
  _target: HTMLElement;
  _onComplete?: VoidFunction;
  _finished: boolean;
  _helperTimeout: NodeJS.Timeout;
