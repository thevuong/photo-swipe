...
import Placeholder from '@/slide/placeholder';
...
import { createElement, setTransform, equalizePoints, roundPoint, toTransformString, clamp } from '@/util/util';

import PanBounds, { Axis } from './pan-bounds';
...
class Slide {
  ...
  getPlaceholderElement() {
    return (this.content.placeholder as Placeholder & { element: HTMLImageElement | HTMLDivElement })?.element;
  }
   ...
   * @returns {number}
   */
  calculateZoomToPanOffset(axis: Axis, point?: Point, prevZoomLevel?: number) {
